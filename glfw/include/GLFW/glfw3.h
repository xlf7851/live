...
GLFWAPI GLFWwindow* glfwCreateWindowEx(int width, int height, const char* title, GLFWmonitor* monitor, GLFWwindow* share, unsigned int nParentHwnd);
...
GLFWAPI void glfwSetWindowPosEx(GLFWwindow* window, int xpos, int ypos, int cx, int cy, int nFlag, int nInsert);
