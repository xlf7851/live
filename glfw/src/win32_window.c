                              ...
                              const _GLFWfbconfig* fbconfig)
{
    ...
    window->win32.handle = CreateWindowExW(exStyle,
                                           ...
                                           xpos, ypos,
                                           fullWidth, fullHeight,
										   window->win32.hParent, // No parent window
                                           NULL, // No window menu
...
void _glfwPlatformSetWindowPosEx(_GLFWwindow* window, int xpos, int ypos, int cx, int cy, int nFlag, int nInsert)
{
	SetWindowPos(window->win32.handle, (HWND)nInsert, xpos, ypos, cx, cy, nFlag);
}
