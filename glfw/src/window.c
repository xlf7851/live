...
GLFWAPI GLFWwindow* glfwCreateWindow(int width, int height,
                                     ...
                                     GLFWwindow* share)
{
	return glfwCreateWindowEx(width, height, title, monitor, share, 0);
	...
	unsigned int nParentHwnd)
{
	...
	window->win32.hParent = nParentHwnd;
...
GLFWAPI void glfwSetWindowPosEx(GLFWwindow* handle, int xpos, int ypos, int cx, int cy, int nFlag, int nInsert)
{
	_GLFWwindow* window = (_GLFWwindow*)handle;
	assert(window != NULL);
	...
	_glfwPlatformSetWindowPosEx(window, xpos, ypos, cx, cy, nFlag, nInsert);
}
