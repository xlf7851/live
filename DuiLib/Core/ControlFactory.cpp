...
namespace DuiLib 
{
	CControlFactory::CControlFactory()
	{
		...
		INNER_REGISTER_DUICONTROL(CCompareValueButtonUI);
		INNER_REGISTER_DUICONTROL(CPieChartUI);
		INNER_REGISTER_DUICONTROL(CEditConinerItemUI);
		INNER_REGISTER_DUICONTROL(CEditContainerUI);
		INNER_REGISTER_DUICONTROL(CEditConinerItemLabelUI);
	}
